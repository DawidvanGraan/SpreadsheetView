Pod::Spec.new do |s|
  ...
  s.frameworks = 'UIKit'
  s.source           = { :git => 'https://github.com/DawidvanGraan/SpreadsheetView.git', :tag => "v#{s.version}" }
